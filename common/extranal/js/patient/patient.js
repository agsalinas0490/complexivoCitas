    ...
    $(".table").on("click", ".editbutton", function () {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                $('#editPatientForm').find('[name="cedula"]').val(response.patient.cedula).end();
                ...
                $('#editPatientForm').find('[name="ciudad"]').val(response.patient.ciudad).end();
    ...
    $(".table").on("click", ".inffo", function () {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                $('.cedulaClass').append(response.patient.cedula).end();
                ...
                $('.ciudadClass').append(response.patient.ciudad).end();
