                                                ...
                                                if (!empty($patient_details)) {
                                                    ...
                                                    <tr class="">
                                                        ...
                                                        <td class="no-print">
                                                            ...
                                                            <a class="btn btn-info btn-xs btn_width delete_button" title="<?php echo lang('delete'); ?>" href="appointment/delete?id=<?php echo $todays_appointment->id; ?>" onclick="return confirm('Está seguro de eliminar este item?');"><i class="fa fa-trash"></i> </a>
                                                ...
                                                <tr class="">
                                                    ...
                                                    <td class="no-print">
                                                        ...
                                                        <?php if ($this->ion_auth->in_group('Doctor')) { ?>
                                                            ...
                                                            <a class="btn btn-info btn-xs btn_width delete_button" href="prescription/delete?id=<?php echo $prescription->id; ?>" onclick="return confirm('Está seguro de eliminar este registro?');"><i class="fa fa-trash"></i> <?php echo lang('delete'); ?></a>
                                                        <?php } ?>
                                                    </td>
                                                </tr>
                                            <?php } ?>
                                            ...
                                            foreach ($schedules as $schedule) {
                                                ...
                                                <tr class="">
                                                    ...
                                                    <td>
                                                        ...
                                                        <a class="btn btn-info btn-xs btn_width delete_button" href="schedule/deleteSchedule?id=<?php echo $schedule->id; ?>&doctor=<?php echo $schedule->doctor; ?>&weekday=<?php 
                                                        echo $schedule->weekday; ?>&all=all" onclick="return confirm('Está seguro de eliminar este registro?');"><i class="fa fa-trash"> </i> <?php echo lang('delete'); ?></a>
                                                    </td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
