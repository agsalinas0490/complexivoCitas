                        ...
                        <tbody>
                            <?php foreach ($departments as $department) { ?>
                                <tr class="">
                                    ...
                                    <td class="no-print">
                                        <button type="button" class="btn btn-danger  editbutton" data-toggle="modal" title="<?php echo lang('edit'); ?>" data-id="<?php echo $department->id; ?>"><i class="fa fa-edit"></i> </button>   
                                        <a class="btn btn-info  delete_button" title="<?php echo lang('delete'); ?>" href="department/delete?id=<?php echo $department->id; ?>" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-trash"></i> </a>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
            ...
            <div class="modal-body">
                <form role="form" action="department/addNew" class="clearfix" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="">
                            <textarea class="ckeditor form-control" name="description" id="editor" value="" rows="10">  </textarea>
                        </div>
                    </div>
