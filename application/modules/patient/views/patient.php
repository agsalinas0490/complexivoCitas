        ...
        <div class="modal-content">
            ...
            <div class="modal-body row">
                ...
                <div class="form-group col-md-6">
                        <label for="exampleInputEmail1"><?php echo lang('cedula'); ?></label>
                        <input type="text" class="form-control" name="cedula"  value='' placeholder="">
                    </div>    
                <div class="form-group col-md-6">
                        <label for="exampleInputEmail1"><?php echo lang('name'); ?> y Apellidos</label>
                    ...
                    <div class="form-group col-md-6">
                        <label for="exampleInputEmail1"><?php echo lang('ciudad'); ?></label>
...
<!-- Formulario para editar la informacion de un paciente-->
        ...
        <div class="modal-content">
            ...
            <div class="modal-body row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <div class="form-group col-md-6">
                        <label for="exampleInputEmail1"><?php echo lang('ciudad'); ?></label>
                        <input type="text" class="form-control" name="ciudad"  value='<?php echo $cedula;?>' placeholder="">
