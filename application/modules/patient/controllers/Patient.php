...
class Patient extends MX_Controller {
    ...
    public function addNew() {
      ...
      $this->form_validation->set_rules('cedula', 'Cedula', 'required|max_length[10]|xss_clean');
        ...
        // Validating ciudad Field
        $this->form_validation->set_rules('ciudad', 'Ciudad', 'trim|required|min_length[2]|max_length[25]|xss_clean');
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            if (empty($id)) {     // Adding New Patient
                if ($this->ion_auth->email_check($email)) {
                    $this->session->set_flashdata('feedback', lang('Este correo electrónico ya se encuentra registrado'));
    ...
    function addMedicalHistory() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            if (!empty($patient_id)) {
                ...
                $patient_ciudad = $patient_details->ciudad;
            } else {
                $patient_name = 0;
                $patient_phone = 0;
                $patient_address = 0;
